...
class CalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cal" do
    assert_difference('Cal.count') do
      post cals_url, params: { cal: { cprice: @cal.cprice, prode: @cal.prode, prodi: @cal.prodi, ryielde: @cal.ryielde, ryieldi: @cal.ryieldi } }
    end
  ...
  test "should update cal" do
    patch cal_url(@cal), params: { cal: { cprice: @cal.cprice, prode: @cal.prode, prodi: @cal.prodi, ryielde: @cal.ryielde, ryieldi: @cal.ryieldi } }
